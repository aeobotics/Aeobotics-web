    ...
    <>
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center bg-obsidian text-stellar-white overflow-hidden">
        ...
        >
          <motion.h1
            custom={0}
            className="font-display text-9xl md:text-10xl text-luminescent-blue mb-8"
          >
            403
          </motion.h1>
          ...
          <motion.p custom={2} className="max-w-xl mx-auto mb-8 text-muted-silver">
            You don't have permission to view this page. If you think this is a mistake, reach out and we'll sort it out.
          </motion.p>
